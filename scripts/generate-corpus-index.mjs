#!/usr/bin/env node
// Generates agent/corpus-index.md — the GET's single source of truth for
...
md += "The GET's single source of truth for **where each corpus page lives** and **which tutorial number maps to which file**. " +

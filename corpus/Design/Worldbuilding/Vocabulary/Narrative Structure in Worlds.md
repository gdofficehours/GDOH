...
- **Narrative** — a series of events which are causally connected
- **Narrative unit** — each event; an actor or agent taking part in an action
- **Narrative thread** — a chain of events revolving around a particular character

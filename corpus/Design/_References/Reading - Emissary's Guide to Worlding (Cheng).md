...
→ [worldto.live](https://worldto.live) · [Amazon](https://www.amazon.com/Emissarys-Guide-Worlding-Ian-Cheng-ebook/dp/B07KGKGNNK)
...
For example, I throw a party at my home. I provide drinks, board games, music. I choose a time. Perhaps my Creator's hold is 0.2?
How about 1.0? He references Hayao Miyazaki who strongly authored films such as [[Film - Spirited Away|Spirited Away]].
...
1. Discover a hack — test it, confirm it works
2. Study the hack to understand why it works reliably
3. See where the hack goes too far; make laws to regulate it
4. Let the Cartoonist develop characters who embody and violate those laws
5. Let the Director create a mythological narrative that situates the hack within meaning

### The Cartoonist-Led Approach (Declarative Containers)

1. Devise a character with an inner contradiction
2. Describe the character by imagining where it lives — the living conditions that created it
3. The living conditions imply the laws of the World
4. Imagine disruptors of those laws and the drama that follows

...
For drafting new tutorials see `The-GET-dev/agent/tutorial-drafting.md`.

## Where this fits

The tutorial spine is layer 1 of the GET's three layers (tutorials, wiki, SPRs). See `The-GET-dev/team/the-get-overview.md`.

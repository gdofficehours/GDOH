...
Four roles that define the design lens for each course assignment. The published overview is `Situated Player Roles.md` — read it for the framework's intent and the discovery-vs-control axis.
...
| `SPR 2 - The Traveler, World as Passage.md` | Traveler | What am I experiencing? | World as Passage |
...
Layer 3 of the GET's three layers (tutorials, wiki, SPRs). The SPRs are the design lens applied throughout the system — the project-mapping skill loads the assignment's named SPR as its primary frame. See `agent/how-the-tutor-works.md`, `agent/map-project-skill.md`, and `agent/ue-capability-map.md`'s "SPR fit" / "Best for" columns.

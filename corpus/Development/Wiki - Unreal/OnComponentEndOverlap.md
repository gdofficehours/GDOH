...
**Door close ([[UE Tutorial 101 - A Floor Plate Opens A Door|Tutorial 101]] pattern):**
...
**Trigger-once zones ([[UE Tutorial 104 - Haunted House Triggers and Events|Tutorial 104]] pattern):**
Tutorial 104's triggers intentionally *don't* use EndOverlap — they fire once and stay triggered (using a bool "HasTriggered" gate). EndOverlap is only useful when you want reversible behavior. If the effect should be permanent (lights stay on, NPC stays triggered), skip EndOverlap entirely.
...
- [[UE Tutorial 101 - A Floor Plate Opens A Door|Tutorial 101]] — door close pattern (BeginOverlap/EndOverlap pair)
- [[UE Tutorial 104 - Haunted House Triggers and Events|Tutorial 104]] — trigger-once pattern (intentionally no EndOverlap)

...
- **1090 — Fork and Update GDOH.** Optional GitHub setup, deliberately numbered high so it reads as *after*, not *before*.
- **1101 — Keep Using GDOH.** What to do once the first session has happened.
...
- New pages carry `type: Tutorial` and `cssclasses: unreal-tutorial`. See `GDOH/scripts/README.md` for the corpus-wide conventions.
...
For drafting *Unreal* tutorials (a different voice and shape entirely) see `GDOH-dev/agent/tutorial-drafting.md`.

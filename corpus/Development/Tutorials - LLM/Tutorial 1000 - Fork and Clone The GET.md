...
- **Pull updates and contribute later** — see `_welcome/contributing-to-the-get.md` in the folder for how to fetch course updates, send your gap log to the instructor, and contribute a reference page.

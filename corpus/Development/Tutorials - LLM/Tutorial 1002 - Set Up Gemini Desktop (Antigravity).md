...
Download and install Antigravity for your platform.
...
Once the app is running, you'll want to select an appropriate model. We recommend **Gemini 3.1 Pro (High)** for the best results.

...
2. Navigate to the GET folder you downloaded in [[Tutorial 1014 - Set Up The GET for Claude Code|Tutorial 1014]] (e.g., `Documents/The-GET-main` or `Documents/The-GET`).
3. Click **Select Folder** (Windows) or **Open** (macOS).

The left sidebar (the **Explorer**) shows the file tree — `_welcome/` (orientation), `agent/` (the AI's operating files), `corpus/` (Tutorials, Wiki, player roles, References), `gaps/`, and `student-notes-private/`.

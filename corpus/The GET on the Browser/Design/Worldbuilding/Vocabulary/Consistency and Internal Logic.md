...
- 9:24 (a trek)
- 25:35 (compare her size to the roly poly)
- 59:25 (comparison again)
...
The Road Runner cartoon doesn't violates its own physics, however absurd the physics are. Wile E. Coyote survives explosions, falls, and being flattened.  The payoff of most of these shorts is the unexpected invention's reveal.  
...
## Game Examples
- [[Game - Portal|Portal]] — a pinnacle example of how rule consistency and incrementally teaching the player couple.  For example, when the ability to place the second portal (orange) emerges, the logic otherwise does not change. 
- [[Game - Baba Is You|Baba Is You]] — rules are literally word blocks. When you reconfigure them, core gameplay changes.  
